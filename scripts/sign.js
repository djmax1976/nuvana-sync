...
function signWithAzure(filePath) {
  ...
  const args = [
    'sign',
    '-kvt',
    process.env.AZURE_SIGN_TENANT_ID,
    '-kvu',
    process.env.AZURE_SIGN_VAULT_URL,
    '-kvi',
    process.env.AZURE_SIGN_CLIENT_ID,
    '-kvs',
    process.env.AZURE_SIGN_CLIENT_SECRET,
    '-kvc',
    process.env.AZURE_SIGN_CERTIFICATE_NAME,
    '-tr',
