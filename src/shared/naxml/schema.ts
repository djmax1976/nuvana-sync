...
export const ManualFileImportSchema = z
  .object({
    ...
    file_type: NAXMLDocumentTypeSchema.optional(),
    // Processing options
    process_sync: z.boolean().default(true).describe('Process synchronously and return result'),
  })
  .refine(
    (data) => {
 ...
 */
export const ScheduledExportStatusSchema = z.enum(['ACTIVE', 'PAUSED', 'DISABLED']);
...
export const CreateScheduledExportSchema = z.object({
  ...
  export_name: z.string().min(1, 'Export name cannot be empty').max(255, 'Export name too long'),
...
export const UpdateScheduledExportSchema = z.object({
  ...
  file_name_pattern: z.string().max(255, 'File name pattern too long').optional(),
...
export type FileWatcherConfigCreate = z.infer<typeof FileWatcherConfigCreateSchema>;
export type FileWatcherConfigUpdate = z.infer<typeof FileWatcherConfigUpdateSchema>;
...
export type POSIntegrationNAXMLConfig = z.infer<typeof POSIntegrationNAXMLConfigSchema>;
 ...
 */
export function validateFileWatcherConfigCreate(data: unknown): FileWatcherConfigCreate {
 ...
 */
export function validateFileWatcherConfigUpdate(data: unknown): FileWatcherConfigUpdate {
 ...
 */
export const NAXMLPrimaryReportPeriodSchema = z.union([z.literal(2), z.literal(98)]);
...
export const NAXMLMovementHeaderSchema = z.object({
  reportSequenceNumber: z.number().int().positive('Sequence number must be positive'),
...
export type NAXMLPrimaryReportPeriod = z.infer<typeof NAXMLPrimaryReportPeriodSchema>;
export type NAXMLMovementReportType = z.infer<typeof NAXMLMovementReportTypeSchema>;
...
export type NAXMLSalesMovementHeader = z.infer<typeof NAXMLSalesMovementHeaderSchema>;
...
export type NAXMLFuelGradeMovementData = z.infer<typeof NAXMLFuelGradeMovementDataSchema>;
export type NAXMLFPMDetail = z.infer<typeof NAXMLFPMDetailSchema>;
export type NAXMLFuelProductMovementData = z.infer<typeof NAXMLFuelProductMovementDataSchema>;
...
export type NAXMLTaxLevelMovementData = z.infer<typeof NAXMLTaxLevelMovementDataSchema>;
...
export type NAXMLItemSalesMovementData = z.infer<typeof NAXMLItemSalesMovementDataSchema>;
export type NAXMLTPMDetail = z.infer<typeof NAXMLTPMDetailSchema>;
export type NAXMLTankProductMovementData = z.infer<typeof NAXMLTankProductMovementDataSchema>;
export type NAXMLTransmissionHeader = z.infer<typeof NAXMLTransmissionHeaderSchema>;
export type NAXMLMovementReportDocument = z.infer<typeof NAXMLMovementReportDocumentSchema>;
 ...
 */
export function validateFuelGradeMovementData(data: unknown): NAXMLFuelGradeMovementData {
 ...
 */
export function validateFuelProductMovementData(data: unknown): NAXMLFuelProductMovementData {
 ...
 */
export function validateTaxLevelMovementData(data: unknown): NAXMLTaxLevelMovementData {
 ...
 */
export function validateItemSalesMovementData(data: unknown): NAXMLItemSalesMovementData {
 ...
 */
export function validateTankProductMovementData(data: unknown): NAXMLTankProductMovementData {
